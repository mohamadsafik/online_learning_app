...
//Colors
const Color kPrimaryColor = Color(0xffED714D);
const Color kBlackColor = Color(0xff181818);
const Color kTabColor = Color(0xffEDF5F9);
...
TextStyle orangeTextStyle = GoogleFonts.plusJakartaSans(
  color: kPrimaryColor,
);
